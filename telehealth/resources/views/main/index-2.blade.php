...
<head>
	...
	<body style="background: linear-gradient(45deg, #5069ba, #b38fb8) no-repeat;">
		...
		<div class="main-wrapper">
			...
			<!-- Header -->
			<header class="header">
				<nav class="navbar navbar-expand-lg header-nav " style="background: linear-gradient(45deg, #5069ba, #b38fb8) no-repeat; border-bottom: 0;">
					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							<li class="active">
								<a href="index-2.html" style="color: white;">Home</a>
							</li>
					...
					<ul class="nav header-navbar-rht">
						<li class="nav-item contact-item">
							...
							<div class="header-contact-detail">
								...
								<p class="contact-info-header"> +7 777 777 7777</p>
							</div>
						</li>
						<li class="nav-item">
			...
			<section class="section section-specialities " style="background: linear-gradient(45deg, #5069ba, #b38fb8) no-repeat;" >
				<div class="container-fluid">
					...
					<h2 style="color: white ;">Make your request</h2>
								<button type="button" href ="request" class="btn btn-outline-primary" style="margin-top: 25pt;">Make a request</button>
				</div>
				   ...
				   <div class="row">
						<div class="col-lg-4">
							<div class="section-header ">
								<h2 style="color: white;">Book Our Doctor</h2>
